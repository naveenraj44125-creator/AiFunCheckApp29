...
exports.optionalAuth = exports.requireAuth = exports.apiRouter = void 0;
...
const authService = new AuthenticationService_1.AuthenticationService(InMemoryStorage_1.storage);
const friendService = new FriendService_1.FriendService(InMemoryStorage_1.storage);
// ============================================
 ...
 */
exports.apiRouter.post('/auth/register', asyncHandler(async (req, res) => {
 ...
 */
exports.apiRouter.post('/auth/login', asyncHandler(async (req, res) => {
 ...
 */
exports.apiRouter.post('/auth/logout', asyncHandler(async (req, res) => {
    ...
    const session = InMemoryStorage_1.storage.getSessionByToken(token);
    if (!session) {
 ...
 */
exports.apiRouter.post('/posts', requireAuth, asyncHandler(async (req, res) => {
    ...
    // Create the post
    const post = await (0, PostService_1.createPost)(req.user.id, content, visibility, InMemoryStorage_1.storage);
 ...
 *   - 404: Post not found
 */
exports.apiRouter.get('/posts/:id', optionalAuth, asyncHandler(async (req, res) => {
    const postId = req.params.id;
    const requesterId = req.user?.id || null;
    // Get the post with visibility check
    const post = await (0, PostService_1.getPost)(postId, requesterId, InMemoryStorage_1.storage);
    if (!post) {
 ...
 *   - 404: Post not found
 */
exports.apiRouter.put('/posts/:id', requireAuth, asyncHandler(async (req, res) => {
    const postId = req.params.id;
    const { content, visibility } = req.body;
    // Update the post
    const post = await (0, PostService_1.updatePost)(postId, req.user.id, { content, visibility }, InMemoryStorage_1.storage);
 ...
 *   - 404: Post not found
 */
exports.apiRouter.delete('/posts/:id', requireAuth, asyncHandler(async (req, res) => {
    const postId = req.params.id;
    // Delete the post
    await (0, PostService_1.deletePost)(postId, req.user.id, InMemoryStorage_1.storage);
    // Return no content
    res.status(204).send();
}));
// ============================================
 ...
 */
exports.apiRouter.post('/friends/request', requireAuth, asyncHandler(async (req, res) => {
 ...
 */
exports.apiRouter.post('/friends/accept/:requestId', requireAuth, asyncHandler(async (req, res) => {
 ...
 *   - 404: Friend request not found
 */
exports.apiRouter.post('/friends/decline/:requestId', requireAuth, asyncHandler(async (req, res) => {
    const { requestId } = req.params;
 ...
 *   - 401: Not authenticated
 */
exports.apiRouter.delete('/friends/:friendId', requireAuth, asyncHandler(async (req, res) => {
 ...
 *   - 401: Not authenticated
 */
exports.apiRouter.get('/friends', requireAuth, asyncHandler(async (req, res) => {
 ...
 */
exports.apiRouter.get('/feed', optionalAuth, asyncHandler(async (req, res) => {
    ...
    // Get the feed
    const feedResult = await (0, FeedService_1.getFeed)(userId, { limit, offset }, InMemoryStorage_1.storage);
...
// Apply error handler
exports.apiRouter.use(errorHandler);
