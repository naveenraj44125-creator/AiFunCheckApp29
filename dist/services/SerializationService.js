...
exports.deserializePost = deserializePost;
exports.serializePosts = serializePosts;
exports.deserializePosts = deserializePosts;
/**
...
function deserializePosts(json) {
    ...
    return parsed.map((item, index) => {
        try {
            ...
            throw new Error(`Invalid post at index ${index}: ${error.message}`);
        }
    });
}
